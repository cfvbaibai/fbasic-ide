...
.manual-control h4 {
  margin: 0 0 6px 0;
  color: var(--app-fill-color-blank);
  text-align: center;
  font-size: 0.9rem;
...
.manual-joystick {
  background: linear-gradient(145deg, var(--app-fill-color-light), var(--app-fill-color));
  border-radius: 8px;
  padding: 6px;
...
.manual-cross {
  ...
  align-items: center;
  gap: 1px;
  background: linear-gradient(145deg, var(--app-fill-color-lighter), var(--app-fill-color));
  border-radius: 6px;
  padding: 4px;
...
.manual-button {
  ...
  height: 28px;
  border: 2px solid var(--app-border-color);
  background: linear-gradient(145deg, var(--app-bg-color-page), var(--app-fill-color-light));
  border-radius: 4px;
  cursor: pointer;
  font-weight: bold;
  color: var(--app-text-color-primary);
...
.manual-button:hover {
  background: linear-gradient(145deg, var(--app-fill-color-lighter), var(--app-fill-color-light));
...
.manual-button:active {
  background: linear-gradient(145deg, var(--app-fill-color), var(--app-fill-color-dark));
  transform: translateY(1px);
  box-shadow: var(--app-box-shadow-dark), 
...
.manual-action-button.active {
  background: linear-gradient(145deg, var(--el-color-success), var(--el-color-success));
  color: var(--app-fill-color-blank);
  border-color: var(--el-color-success);
  box-shadow: var(--app-box-shadow-dark), inset 1px 1px 2px rgba(255,255,255,0.2);
  opacity: 0.9;
}
