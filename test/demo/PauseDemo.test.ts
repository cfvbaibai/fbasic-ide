...
describe.skipIf(!shouldRunPauseDemoTests)('Pause Demo Program', () => {
  ...
  describe('Execution Tests', () => {
    ...
    it('should produce correct output sequence', async () => {
      ...
      expect(calls[2]).toContain('Countdown:')
      expect(calls[2]).toContain('5')
      expect(calls[3]).toContain('Countdown:')
      expect(calls[3]).toContain('4')
      expect(calls[4]).toContain('Countdown:')
      expect(calls[4]).toContain('3')
      expect(calls[5]).toContain('Countdown:')
      expect(calls[5]).toContain('2')
      expect(calls[6]).toContain('Countdown:')
      expect(calls[6]).toContain('1')
...
60 END`
      ...
      const calls = printOutputMock.mock.calls.map(call => call[0])
      expect(calls[0]).toContain('Loop')
      expect(calls[0]).toContain('1')
      expect(calls[1]).toContain('Loop')
      expect(calls[1]).toContain('2')
      expect(calls[2]).toContain('Loop')
      expect(calls[2]).toContain('3')
